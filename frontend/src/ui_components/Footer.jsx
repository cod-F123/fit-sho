    ...
    return (
        <>
            <div className="flex w-full items-center flex-col bg-gray-100 pt-10">
                ...
                <div className="grid w-full grid-cols-12 mt-10 gap-6 mb-7 px-5" dir="rtl">
                    <div className="lg:col-span-8 col-span-12 grid grid-cols-12 gap-6">
                        ...
                        <div className="lg:col-span-3 sm:col-sm-4 col-span-12">
                            ...
                            <div className="flex">
                                <Link
                                    to="/"
                                    className="text-red-500 md:mt-2 lg:mt-4 font-medium "
                                >
                                    <svg
                                ...
                                <Link
                                    to="/"
                                    className="text-green-700 md:mt-2 mr-3 lg:mt-4 font-medium "
                                >
                                    <svg
                                        xmlns="http://www.w3.org/2000/svg"
                                        width="33"
