...
function Nav() {
    ...
    return (
        <>
            ...
            <div
                ref={menu}
                className={`fixed z-50 top-0 right-0 h-full bg-gray-400 transition-all duration-500 ease-in-out overflow-hidden md:hidden ${
                    openMenu ? "w-3/4 opacity-100" : "w-0 opacity-0"
                }`}
            >
                <ul className={`p-5 ${openMenu ? "flex" : "hidden"} flex-col items-end text-black text-right`}>
                    <li>
                        <Link to="/" onClick={onMenuAction} className="block text-xl font-bold py-2">
                            خانه
                        </Link>
                    </li>
                    <li>
                        <Link to="/packages" onClick={onMenuAction} className="block text-xl font-bold py-2">
                            بسته‌های رژیمی
                        </Link>
                    </li>
                    <li>
                        <Link to="/products" onClick={onMenuAction} className="block text-xl font-bold py-2">
                            سفارش روزانه
                        </Link>
                    </li>
                    <li>
