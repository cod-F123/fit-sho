        ...
        <>
            ...
            >
                <ul
                    ...
                    } flex-col items-center gap-5 text-black text-right`}
                >
                    <li>
                        <Link
                            to="/"
                    ...
                    <li>
                        <Link
                            onClick={onMenuAction}
                            to="/cart"
                            className="rounded-md relative flex bg-green-300 text-blue-950 p-2 md:p-1 lg:p-2"
                        >
                            <svg
                                xmlns="http://www.w3.org/2000/svg"
                                width="27"
                        ...
                        {!isLogin ? (
                            <>
                                <Link
                                    onClick={onMenuAction}
                                    to={"/accounts/login"}
                                    className="rounded-md  bg-black text-white font-bold px-6 py-2 md:px-4 lg:px-6 md:py-1 lg:py-2"
                                >
                                    ثبت نام / ورود
                                </Link>
                            </>
                            ...
                            <>
                                <Link
                                    onClick={onMenuAction}
                                    to={"/accounts"}
                                    className="rounded-md text-black font-bold px-6 py-2 md:px-4 lg:px-6 md:py-1 lg:py-2"
                                >
                                    <svg
                                        xmlns="http://www.w3.org/2000/svg"
                                        width="40"
                    ...
                    <li className="border-b-4 border-gray-900 ">
                        <h1
